...
# SuperJob (офиц. API, ключ в .env SUPERJOB_APP_ID). Гео — server-side через town ids.
SJ_TOWN_IDS = [12, 639]   # 12 = Нижний Новгород, 639 = Дзержинск (Нижегородская обл.)
SJ_PERIOD = 3             # период SuperJob: 1=сутки, 3=3 дня, 7=неделя, 0=всё
